...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description:
      "A responsive barber shop website with services, gallery, and contact information.",
    longDescription:
      "A clean barbershop brand site highlighting services, atmosphere, and booking-friendly contact details.",
    features: ["Services section", "Gallery", "Contact info"],
    challenges: ["Keeping a premium feel with a simple stack"],
    problems: ["Focused on strong typography and section spacing"],
